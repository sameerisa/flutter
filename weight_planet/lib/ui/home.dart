    ...
    setState(() {
      ...
      switch(radioValue){
        case 0:
          ...
          _formattedText = "Your weight one Pluto is ${_finalResult.toStringAsFixed(1)}";
          break;
        case 1:
          _finalResult = calculateWeight(_weightController.text, .38);
          _formattedText = "Your weight one Mars is ${_finalResult.toStringAsFixed(1)}";
          break;
        case 2:
          _finalResult = calculateWeight(_weightController.text, .91);
          _formattedText = "Your weight one Venus is ${_finalResult.toStringAsFixed(1)}";
    ...
    return new Scaffold(
      ...
      body: new Container(
        ...
        child: new ListView(
          ...
          children: <Widget>[
            new Image.asset('images/planet.png.png',
            height: 133.8,
              width: 200.0,),
